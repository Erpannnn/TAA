        ...
        <div class="modal-content">
            <div class="modal-body">
                ...
                <button type="button" onclick="downloadPDF('<?= $_SESSION['invoice_no'] ?>')"
                    class="btn btn-warning"><i class="fa fa-download" aria-hidden="true"></i> Download PDF</button>
        ...
        <div class="col-md-12">
            <div class="card mt-4">
                <div class="card-header">
                    <h4>Summary <a href="orders-create.php" class="btn btn-danger float-end"><i class="fa fa-chevron-left" aria-hidden="true"></i>  Back to create order</a>
                    </h4>
                </div>
                <div class="card-body">
                    ...
                    <?php if (isset($_SESSION['productItems'])): ?>
                        <div class="mt-4 text-end">
                            ...
                            <button class="btn btn-warning px-4 mx-1"
                                onclick="downloadPDF('<?= $SESSION['invoice_no']; ?>')"><i class="fa fa-download" aria-hidden="true"></i> Download PDF</button>
